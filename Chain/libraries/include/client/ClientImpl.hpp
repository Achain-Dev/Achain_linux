        ...
        namespace detail {
            ...
            public:
                ...
                */
                ...
                void start_local_pending_loop();
                void cancel_local_pending_loop();
                void local_pending_loop();
                fc::future<void> _local_pending_loop_done;
                ...
                std::list<SignedTransaction>         _local_pending_list;
                std::list<WalletTransactionEntry>    _local_entry_list;
